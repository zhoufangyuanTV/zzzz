...
namespace test_lib {
    ...
    static int n,limA,limB,cntA,cntB,cnt,tot,x,y,reported_edge,tp;
	...
	void main() {
        scanf("%d%d%d%d",&n,&limA,&limB,&tp);reported_edge=0;cntA=cntB=cnt=0;
		...
		puts("n9034809m09s09238x0923d92ur8jfur");
		printf("%d %d\n",cntA,cntB);
	}
}
